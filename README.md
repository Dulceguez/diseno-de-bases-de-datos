...
- Claves (superclave, candidata, primaria y foránea)
- Normalización (dependencias funcionales, BCNF y formas normales)
- Álgebra y cálculo relacional
- Lenguaje SQL (consultas, subconsultas, agregación, DML)
